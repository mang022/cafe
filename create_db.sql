...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `barcode` varchar(32) COLLATE utf8mb4_unicode_520_ci NOT NULL COMMENT '바코드',
  `expiration_date` bigint(20) NOT NULL COMMENT '유통기한',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci COMMENT='상품';
